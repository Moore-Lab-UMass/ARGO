...
export type FetchSnpAlleleQuery = { __typename?: 'Query', getSNPAllele?: Array<{ __typename?: 'AlleleResult', altallele: string, refallele: string, chrom: string, start: number, snp: string } | null> | null };
